...
RSpec.describe Api::V1::VideosController, type: :controller do
  describe 'GET #index' do
    ...
    before do
      ...
      # Configurar expectativas para todos os possíveis cenários
      allow_any_instance_of(PexelsService).to receive(:fetch_videos) do |_, page, per_page|
        case [ page, per_page ]
        when [ 1, 10 ]
          mock_videos
        when [ 2, 15 ]
          ...
          raise "Unexpected arguments: #{[ page, per_page ]}"
        end
      end
    end
